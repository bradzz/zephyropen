package zephyropen.device.arduino;
 ...
 * 
 */
public class ArduinoSerialPort extends AbstractPort implements Port, SerialPortEventListener {
    ...
    public ArduinoSerialPort(String addr) {

        address = addr;
        command.add("kkk", "element");
        //= new Command();
